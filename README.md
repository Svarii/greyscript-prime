# GreyScript Prime ![Version Badge](https://img.shields.io/badge/version-0.1a-red)
...
**GreyScript Prime** is an extension for **GreyScript** that adds powerful methods for object manipulation. Combined with tools like `Greybel VS`, `Plant UML`, and `Markdown Preview Enhanced with litvis`, GreyScript Prime is designed to boost your coding efficiency and make your development experience in **VSCode** seamless and productive.

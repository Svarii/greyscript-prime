...
To install GreyScript Plus, follow these steps:

1. Clone the repository:

   ```bash
   git clone https://github.com/Svarii/GreyScript.git
   ```
...
Import GreyScript Plus into your GreyScript projects to start using the extended methods. Here's a quick example:
...
Here's a screenshot showcasing GreyScript Plus in action within VSCode:

![GreyScript Plus in VSCode](path_to_example_screenshot) <!-- Replace with actual image path -->

![Another Screenshot](path_to_second_screenshot) <!-- Replace with actual image path -->

## License

GreyScript Plus is released under the MIT License. See [LICENSE](LICENSE) for more details.

---

*Enhance your GreyScript development experience today with GreyScript Plus!*
